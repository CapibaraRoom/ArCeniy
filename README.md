...
Во время запуска АрСений выгружает в RAM файловую систему из iso дистрибутива, а так же накладывает на неё фрагменты, сформированные в модулях xzm. Раздел *home/* монтируется без выгрузки. Такой подход позволяет поддерживать систему в чистом и безопасном состоянии.
